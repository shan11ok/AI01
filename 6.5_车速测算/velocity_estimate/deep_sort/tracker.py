...
class Tracker:
    ...
    def __init__(self, metric, trans_rect, accl=0., max_age=7, n_init=3, max_iou_distance=0.7):
        self.metric = metric
        self.max_iou_distance = max_iou_distance
        self.max_age = max_age
        self.n_init = n_init
        self.kf = kalman_filter.KalmanFilter(trans_rect,accl)
        self.tracks = []
        self._next_id = 1
        self.counts = {}
        self.count_deque = deque(maxlen=7)
    ...
    def update(self, detections, line=[(0,0),(0,0)]):
    ...
    def _initiate_track(self, detection):
        ...
        self.tracks.append(Track(
            ...
            detection.pre_class, detection.feature))
        self._next_id += 1
