...
if __name__ == '__main__':
    ...
    char_model_path = os.path.join(cur_dir,'./carIdentityData/model/char_recongnize/model.ckpt-530.meta')
    img = cv2.imread('./carIdentityData/images/3.jpg')
